...
// GNB Menu Items (Type A - Province with Council + Tourism)
const GNB_MENU = [
    { name: '홈', slug: '/' },
    ...
    { name: '지역소식', slug: '/category/jeonnam' },
    { name: '관광', slug: '/tour' },
];
            ...
            <div className="kn-topbar hidden md:block">
                <div className="container-kn h-full flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4 text-[12px]">
                        <Link href="/reporter/login" className="hover:text-primary">
                            기자 로그인
                        </Link>
                        ...
                        <div className="kn-logo">
                            <Link href="/" className="block">
                                <h1 className="kn-logo-text">
                                    코리아NEWS <span style={{ color: '#0066CC' }}>{CURRENT_SITE.name}</span>
                                </h1>
            ...
            >
                ...
                >
                    ...
                    <div className="h-14 bg-primary flex items-center justify-between px-4">
                        <span className="text-white font-bold">코리아NEWS {CURRENT_SITE.name}</span>
                        <button
                            onClick={() => setIsMobileMenuOpen(false)}
