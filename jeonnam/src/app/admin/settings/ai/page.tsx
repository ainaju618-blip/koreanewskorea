...
export default function AISettingsPage() {
    ...
    return (
        <div className="space-y-5 max-w-6xl mx-auto">
            ...
            {saveMessage && (
                <div className="bg-[#1f3a5f] border border-[#2d4a6f] rounded-lg px-4 py-3 flex items-start gap-3">
                    ...
                    <button
                        ...
                        className="ml-auto text-blue-400 hover:text-blue-300 text-lg leading-none"
                    >
                        &times;
                    </button>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                {/* Left: API 키 관리 (1/3) */}
                <div className="bg-[#161b22] rounded-xl border border-[#30363d] p-5 space-y-6">
                    {/* API 키 입력 */}
                    <APIKeyManager
                        settings={settings}
                        testing={testing}
            ...
            {/* Notice - Compact */}
            <div className="bg-[#3d2f1f] border border-[#5c4a2a] rounded-lg px-4 py-3 flex items-center gap-3">
