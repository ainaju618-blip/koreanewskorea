...
export async function generateMetadata({ params }: NewsDetailProps): Promise<Metadata> {
    ...
    return {
        ...
        alternates: {
            canonical: `https://gwangju.koreanewsone.com/news/${id}`,
        },
        robots: {
...
export default async function NewsDetailPage({ params }: NewsDetailProps) {
    ...
    const authorProfileUrl = reporter
        ? `https://gwangju.koreanewsone.com/author/${reporter.id}`
        : undefined;
    ...
    const jsonLd = {
        ...
        publisher: {
            ...
            logo: {
                '@type': 'ImageObject',
                url: 'https://gwangju.koreanewsone.com/logo.png',
                width: 600,
                height: 60,
            },
        },
        mainEntityOfPage: {
            '@type': 'WebPage',
            '@id': `https://gwangju.koreanewsone.com/news/${id}`,
        },
