...
export async function generateMetadata({ params }: LocationPageProps): Promise<Metadata> {
    ...
    return {
        title: `오시는 길 | ${config.name} | 코리아NEWS`,
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                    ...
                    <div className="bg-slate-50 rounded-xl p-6">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <a href={`mailto:${config.email}`} className="text-gray-700 hover:text-[#A6121D]">
                                    {config.email}
                                </a>
                            </li>
                            <li className="flex items-center gap-3">
                ...
                <div className="flex gap-4 text-sm pt-8 border-t">
                    <Link href={`/${region}/about`} className="text-gray-500 hover:text-gray-700">회사 소개</Link>
                    <Link href={`/${region}/history`} className="text-gray-500 hover:text-gray-700">연혁</Link>
                    <Link href={`/${region}/organization`} className="text-gray-500 hover:text-gray-700">조직도</Link>
                </div>
            </div>
        </div>
    );
