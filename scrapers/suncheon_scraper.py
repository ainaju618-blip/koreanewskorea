...
# 순천시# 실제 보도자료 URL (브라우저 확인됨)
LIST_URL = 'http://www.suncheon.go.kr/kr/news/0006/0001/'
LIST_SELECTORS = ['tbody tr td a[href*="?mode=view&seq="]', 'a[href*="view"]', '.board_list a']
CONTENT_SELECTORS = ['div#DivContents', 'div.board_view_con', 'div.view_content', 'div.board_view', 'div.contents', 'div#content', 'article', '.view_context', '#txt']
            ...
            for i in range(min(count, 10)):
                try:
                    ...
                    if not title or not href:
                        continue
                    if 'view' not in href.lower() and 'View' not in href:
                        continue
