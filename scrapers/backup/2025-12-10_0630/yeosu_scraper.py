...
# 여수시 실제 보도자료 URL
LIST_URL = 'https://www.yeosu.go.kr/www/govt/news/release'

# 여수시 실제 셀렉터
LIST_SELECTORS = ['a[href*="boardView"]', 'a[href*="view"]', '.board_list a', 'ul.list li a', 'tbody tr a']
CONTENT_SELECTORS = ['div.view_content', 'div.board_view', 'div.view_cont', 'article']
