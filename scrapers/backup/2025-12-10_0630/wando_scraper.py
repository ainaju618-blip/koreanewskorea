...
LIST_URL = 'https://www.wando.go.kr/www/news/press'
LIST_SELECTORS = ['a[href*="nttId="]', 'tbody tr a']

def fetch_detail(page, url):
    if not safe_goto(page, url, timeout=20000): return "", None
    elem = wait_and_find(page, ['div.view_content', 'div.board_view', 'div.bbs_view'], timeout=5000)
