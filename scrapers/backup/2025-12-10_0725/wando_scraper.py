...
REGION_CODE, REGION_NAME, CATEGORY_NAME = 'wando', '완도군', '전남'
BASE_URL = 'https://www.wando.go.kr'
# 실제 보도자료 URL (사용자 브라우저에서 확인)
LIST_URL = 'https://www.wando.go.kr/wando/sub.cs?m=299'
LIST_SELECTORS = ['a[href*="nttId="]', 'a[href*="view"]', 'tbody tr a', '.board_list a']
CONTENT_SELECTORS = ['div.view_content', 'div.board_view', 'article', '.cont_view', 'div.bbsview_cont']
