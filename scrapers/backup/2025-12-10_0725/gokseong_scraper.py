...
REGION_CODE, REGION_NAME, CATEGORY_NAME = 'gokseong', '곡성군', '전남'
BASE_URL = 'https://www.gokseong.go.kr'
LIST_URL = 'https://www.gokseong.go.kr/open_info/gokseong_news/press_release'
LIST_SELECTORS = ['a[href*="view"]', 'a[href*="View"]', 'tbody tr a', '.board_list a']
CONTENT_SELECTORS = ['div.view_content', 'div.board_view', 'article', '.cont_view']
