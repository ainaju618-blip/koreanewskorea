...
REGION_CODE, REGION_NAME, CATEGORY_NAME = 'damyang', '담양군', '전남'
BASE_URL = 'https://www.damyang.go.kr'
# 실제 보도자료 URL (검색결과 기반)
LIST_URL = 'https://www.damyang.go.kr/board/list.damyang?boardId=BBS_0000021&menuId=DAMYANG000052'
LIST_SELECTORS = ['a[href*="view"]', 'tbody tr td.title a', '.board_list a']
CONTENT_SELECTORS = ['div.view_content', 'div.board_view', 'article', '.cont_view', '.view_cont', '.con_txt', '#txt']
