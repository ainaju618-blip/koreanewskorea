...
# 실제 보도자료 URL (브라우저 확인됨)
LIST_URL = 'https://gwangyang.go.kr/board.es?mid=a11007000000&bid=0057'
LIST_SELECTORS = ['a[href*="act=view"]', 'tbody tr td.subject a', '.board_list a', 'a[href*="view"]']
CONTENT_SELECTORS = ['div.view_content', 'div.board_view', 'article', '.cont_view', '.view_cont', 'div.content']
