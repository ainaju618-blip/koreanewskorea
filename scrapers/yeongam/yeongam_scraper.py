...
REGION_CODE, REGION_NAME, CATEGORY_NAME = 'yeongam', '영암군', '전남'
BASE_URL = 'https://www.yeongam.go.kr'
# 실제 보도자료 URL (검색으로 확인)
LIST_URL = 'https://www.yeongam.go.kr/home/www/open_info/yeongam_news/press'
LIST_SELECTORS = ['a[href*="view"]', 'a[href*="View"]', 'tbody tr td a', '.board_list a']
