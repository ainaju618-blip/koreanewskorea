...
# 여수시# 실제 보도자료 URL (브라우저 확인됨)
LIST_URL = 'https://www.yeosu.go.kr/www/govt/news/release/press'
LIST_SELECTORS = ['a.basic_cont', 'td.subject a', 'tbody tr td a']
CONTENT_SELECTORS = ['div.viewbox', 'div.contbox', 'div.view_cont', 'div.board_view', 'div.view_content', 'article', '.view_context', '#txt']
