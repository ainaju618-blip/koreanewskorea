# -*- coding: utf-8 -*-
"""대전광역시 보도자료 스크래퍼 v4.0 (Simple Playwright)
- 운영서버 방식으로 단순화
- 테이블 구조
"""
...
LIST_URL = 'https://www.daejeon.go.kr/drh/board/boardNormalList.do?boardId=normal_0096&menuSeq=1631'
        ...
        while page_num <= 5 and not stop and collected_count < max_articles:
            ...
            for i in range(row_count):
                ...
                try:
                    ...
                    # 대전시: 번호(0), 제목(1), 담당부서(2), 첨부(3), 공고일(4), 조회수(5)
                    n_date = None
                    try:
                        date_cell = row.locator('td').nth(4)
