# -*- coding: utf-8 -*-
"""울산광역시 보도자료 스크래퍼 v4.0 (Simple Playwright)
- 운영서버 방식으로 단순화
- 테이블 구조
"""
...
LIST_URL = 'https://www.ulsan.go.kr/u/rep/bbs/list.do?bbsId=BBS_0000000000000051&mId=001004003000000000'
        ...
        while page_num <= 5 and not stop and collected_count < max_articles:
            ...
            for i in range(row_count):
                ...
                try:
                    ...
                    # 울산시: 번호(0), 제목(1), 작성자(2), 날짜(3), 조회수(4)
                    n_date = None
                    try:
