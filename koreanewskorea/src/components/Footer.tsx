...
export default function Footer() {
    ...
    // Check if on news page (supports both /news/id and /region/news/id)
    const getArticleId = (): string | null => {
        // Match /region/news/id or /news/id
            ...
            <footer className="kn-footer">
                <div className="container-kn">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="md:col-span-2">
                            ...
                            <div className="kn-footer-info">
                                ...
                                <p>주소: 전라남도 무안군 삼향읍</p>
                                <p>대표전화: 010-2631-3865 | 이메일: {siteConfig.email}</p>
                                <p>등록번호: 전남 가 00000호 | 등록일: 2024년 1월 1일</p>
                            </div>

                            {/* Footer Links */}
                            <div className="kn-footer-links">
                                <Link href={buildUrl('/about')} className="kn-footer-link">
                                    회사소개
                                </Link>
                                <Link href={buildUrl('/privacy')} className="kn-footer-link">
                                    개인정보처리방침
                                </Link>
                                <Link href={buildUrl('/terms')} className="kn-footer-link">
                                    이용약관
                                </Link>
                                <Link href={buildUrl('/contact')} className="kn-footer-link">
                                    제보하기
                                </Link>
                                <Link href={buildUrl('/ad-inquiry')} className="kn-footer-link">
                                    광고문의
                                </Link>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                <li>
                                    <Link href={buildUrl('/category/politics')} className="kn-footer-link">
                                        정치
                                    </Link>
                                </li>
                                <li>
                                    <Link href={buildUrl('/category/economy')} className="kn-footer-link">
                                        경제
                                    </Link>
                                </li>
                                <li>
                                    <Link href={buildUrl('/category/society')} className="kn-footer-link">
                                        사회
                                    </Link>
                                </li>
                                <li>
                                    <Link href={buildUrl('/category/culture')} className="kn-footer-link">
                                        문화
                                    </Link>
                                </li>
                                <li>
                    ...
                    <div className="kn-footer-copyright">
                        <p>
                            Copyright &copy; {currentYear} 코리아NEWS {siteConfig.name}. All rights reserved.
                        </p>
                        <p className="mt-1">
