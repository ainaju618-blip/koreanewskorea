...
import { BASE_DOMAIN } from "@/config/site-regions";

// Site URL for path-based routing
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || BASE_DOMAIN;

// Portal metadata
const siteName = '코리아NEWS';
const siteDescription = '광주·전남 지역 뉴스 포털';
const primaryRegions = '광주, 목포, 여수, 순천, 나주, 광양, 담양, 고흥, 해남';
...
export const metadata: Metadata = {
  ...
  keywords: [
    '광주 뉴스', '목포 뉴스', '여수 뉴스', '순천 뉴스', '나주 뉴스',
    '광양 뉴스', '담양 뉴스', '고흥 뉴스', '해남 뉴스',
    '전라남도 뉴스', '광주광역시 뉴스', '지역 뉴스', '코리아NEWS',
  ],
