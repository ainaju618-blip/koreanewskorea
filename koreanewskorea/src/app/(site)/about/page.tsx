...
export default function AboutPage() {
    ...
    const jsonLd = {
        ...
        url: CURRENT_SITE.siteUrl,
        logo: `${CURRENT_SITE.siteUrl}/logo.png`,
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <section className="mb-12 bg-slate-900 text-white rounded-xl p-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <a
                            href={`mailto:${CURRENT_SITE.email}?subject=[제보]`}
                ...
                <section className="mb-12 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl p-6">
                    ...
                    <a
                        href={`mailto:${CURRENT_SITE.email}?subject=[프로그램 제작 의뢰]`}
                ...
                <section className="mb-12">
                    ...
                    <div className="space-y-3 text-gray-700">
                        ...
                        <p className="flex items-center gap-2">
                            ...
                            <a href={`mailto:${CURRENT_SITE.email}`} className="text-blue-600 hover:underline">
                                {CURRENT_SITE.email}
                            </a>
                        </p>
                    </div>
