...
const DEFAULT_SETTINGS: HeroSliderSettings = {
    regions: ['gwangju', 'gwangju', 'gwangju', 'gwangju', 'gwangju', 'gwangju'],
    interval: 4000,
    enabled: true,
};
...
export default function HeroSliderSettingsPage() {
    ...
    useEffect(() => {
        const fetchSettings = async () => {
            try {
                const res = await fetch('/api/site-settings?key=hero_slider_gwangju');
                if (res.ok) {
    ...
    const handleSave = async () => {
        ...
        try {
            const res = await fetch('/api/site-settings', {
                ...
                body: JSON.stringify({
                    key: 'hero_slider_gwangju',
                    value: settings,
                    description: 'Gwangju Site D788C5b4B85c C2acB77cC774B354 C124C815 (Ad11C8fc)',
                }),
            });
            ...
            <header className="flex justify-between items-start">
                <div>
                    <h1 className="text-2xl font-bold text-[#e6edf3] flex items-center gap-3">
                        ...
                        D788C5b4B85c C2acB77cC774B354 C124C815 (Ad11C8fc)
                    </h1>
                    <p className="text-sm text-[#8b949e] mt-2">
                        Ad11C8fc C0acC774D2b8 Ba54C778 D398C774C9c0 D788C5b4B85c C2acB77cC774B354B97c C124C815D569B2c8B2e4
                    </p>
                </div>
                <button
                    onClick={handleSave}
