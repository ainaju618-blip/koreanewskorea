/**
 * Region Repository
 * Infrastructure layer - handles region configuration data
 * 
 * Note: Currently uses hardcoded data, but can be migrated to DB later
 */

import { RegionConfig } from '../../domain/entities';
 ...
 */
export function getByCode(code: string): RegionConfig | null {
 ...
 */
export function getNearby(code: string): string[] {
 ...
 */
export function getTier(code: string): 1 | 2 | 3 {
 ...
 */
export function getAll(): RegionConfig[] {
 ...
 * Get regions by tier
 */
export function getByTier(tier: 1 | 2 | 3): RegionConfig[] {
 ...
 */
export function getDefault(): RegionConfig {
