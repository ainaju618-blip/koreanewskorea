...
// 사이트 기본 URL
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://gwangju.gwangju.koreanewsone.com';

export const metadata: Metadata = {
  // 기본 메타데이터
  title: {
    default: '코리아NEWS 광주 - 광주광역시 지역 뉴스',
    template: '%s | 코리아NEWS',
  },
  description: '광주, 전남, 나주시 뉴스와 AI/교육 정보를 가장 빠르게 전달합니다.',
  keywords: ['광주뉴스', '전남뉴스', '나주뉴스', '지역뉴스', '혁신도시', 'AI뉴스', '코리아NEWS 광주'],
  authors: [{ name: '코리아NEWS 광주', url: siteUrl }],
  creator: '코리아NEWS 광주',
  publisher: '코리아NEWS 광주',
