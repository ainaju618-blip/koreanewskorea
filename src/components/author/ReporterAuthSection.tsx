...
// ============================================================================
// ⚠️ FALLBACK 전용 - DB 카테고리 API 실패 시에만 사용됨!
// ============================================================================
// 📍 메인 소스: /api/categories (DB categories 테이블)
// 📍 이 하드코딩은 API 실패 시 fallback으로만 사용됨
// 📍 카테고리 변경 시: DB를 먼저 수정하고, 여기도 동기화 필요
// ============================================================================
// 지역별 카테고리 매핑 (DB 값과 일치해야 함: "나주시", "광주광역시", "장성군" 등)
// ⚠️ 2025-01-10 수정: "소방서소식" → "읍면동소식"으로 변경 (네비게이션과 동기화)
export const REGION_CATEGORIES: Record<string, string[]> = {
    // 시 단위
    "나주시": ["나주시소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "목포시": ["목포시소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "순천시": ["순천시소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "여수시": ["여수시소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "광양시": ["광양시소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    // 광역시
    "광주광역시": ["광주소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    // 군 단위
    "담양군": ["담양군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "곡성군": ["곡성군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "구례군": ["구례군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "고흥군": ["고흥군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "보성군": ["보성군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "화순군": ["화순군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "장흥군": ["장흥군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "강진군": ["강진군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "해남군": ["해남군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "영암군": ["영암군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "무안군": ["무안군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "함평군": ["함평군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "영광군": ["영광군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "장성군": ["장성군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "완도군": ["완도군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "진도군": ["진도군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "신안군": ["신안군소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    // 광역 단위
    "전체": ["전국소식", "정치", "경제", "사회", "문화", "오피니언", "맛집", "여행"],
    "전라남도": ["전남소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
    "전라남도교육청": ["교육소식", "학교소식", "정책소식", "오피니언"],
    "광주시교육청": ["교육소식", "학교소식", "정책소식", "오피니언"],
    // 기본값
    "default": ["지역소식", "의회소식", "교육소식", "읍면동소식", "기업소식", "오피니언", "맛집", "여행"],
};
