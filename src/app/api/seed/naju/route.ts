...
const NAJU_PLACES = [
  ...
  },
  {
    ...
    phone: '061-339-8687',
    thumbnail_url: 'https://images.unsplash.com/photo-1600298881974-6be191ceeda1?w=800&q=80',
    lat: 34.9894,
    lng: 126.7111,
    is_featured: true,
    status: 'published',
  },
  {
    ...
    phone: '061-339-8687',
    thumbnail_url: 'https://images.unsplash.com/photo-1583400621155-97fe5a2d2f47?w=800&q=80',
    lat: 34.9889,
    lng: 126.7108,
    is_featured: true,
    status: 'published',
  },
  {
    ...
    phone: '061-332-4692',
    thumbnail_url: 'https://images.unsplash.com/photo-1548115184-bc6544d06a58?w=800&q=80',
    lat: 34.9922,
    lng: 126.7183,
    is_featured: false,
    status: 'published',
  ...
  },
  {
    ...
    phone: '061-339-8916',
    thumbnail_url: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&q=80',
    lat: 34.9561,
    lng: 126.6994,
    is_featured: true,
    status: 'published',
  },
  {
    ...
    phone: '061-330-8253',
    thumbnail_url: 'https://images.unsplash.com/photo-1514907283155-ea5f4094c70c?w=800&q=80',
    lat: 34.9500,
    lng: 126.7500,
    is_featured: false,
    status: 'published',
  },
  {
    ...
    phone: '061-330-7800',
    thumbnail_url: 'https://images.unsplash.com/photo-1533929736458-ca588d08c8be?w=800&q=80',
    lat: 34.9750,
    lng: 126.7250,
    is_featured: false,
    status: 'published',
  ...
  // 맛집
  {
    ...
    phone: '061-333-4292',
    thumbnail_url: 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=800&q=80',
    lat: 34.9883,
    lng: 126.7139,
    is_featured: true,
    status: 'published',
  },
  {
    ...
    phone: '061-332-1234',
    thumbnail_url: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800&q=80',
    lat: 35.0167,
    lng: 126.7833,
    is_featured: false,
    status: 'published',
  },
  {
    ...
    phone: '061-333-5678',
    thumbnail_url: 'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=800&q=80',
    lat: 34.9556,
    lng: 126.7000,
    is_featured: true,
    status: 'published',
  },
  {
    ...
    phone: '061-332-9012',
    thumbnail_url: 'https://images.unsplash.com/photo-1498654896293-37aacf113fd9?w=800&q=80',
    lat: 34.9890,
    lng: 126.7120,
    is_featured: false,
    status: 'published',
  ...
  },
  {
    ...
    phone: '061-333-3000',
    thumbnail_url: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=800&q=80',
    lat: 34.9560,
    lng: 126.7010,
    is_featured: false,
    status: 'published',
