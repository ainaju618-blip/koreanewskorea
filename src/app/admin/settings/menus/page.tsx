        ...
        <div className="space-y-6">
                        ...
                        {menus.map((menu) => (
                            <div key={menu.id} className="relative group">
                                ...
                                {menu.is_mega && menu.category && (
                                    <div className="absolute top-full left-0 mt-1 bg-white rounded-lg shadow-lg p-4 hidden group-hover:block z-10 min-w-[200px]">
                                        <div className="text-xs text-gray-500 mb-2">하위 카테고리</div>
                ...
                <table className="w-full text-left">
                    <thead>
                        <tr className="bg-gray-50 border-b">
                            ...
                            <th className="p-4 text-xs font-semibold text-gray-500 uppercase">메뉴명</th>
                            <th className="p-4 text-xs font-semibold text-gray-500 uppercase">타입</th>
                            <th className="p-4 text-xs font-semibold text-gray-500 uppercase">연결</th>
                            <th className="p-4 text-xs font-semibold text-gray-500 uppercase">옵션</th>
            ...
            {showModal && (
                <>
                    ...
                    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-2xl z-50 w-[450px]">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            {formData.type === 'category' && (
                                <label className="flex items-center gap-2">
                                    ...
                                    />
                                    <span className="text-sm text-gray-700">메가메뉴 사용 (하위 카테고리 드롭다운)</span>
                                </label>
                            )}
