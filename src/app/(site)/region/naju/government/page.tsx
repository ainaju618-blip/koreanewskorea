...
import { Building2, Clock, Loader2, ChevronRight, ChevronLeft } from 'lucide-react';
...
export default function NajuGovernmentPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative text-white py-12 md:py-16 overflow-hidden">
        {/* Background Image */}
        <Image
          src="/images/hero/government-hero.png"
          alt="나주시 소식 배경"
          fill
        ...
        />
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-900/70 to-emerald-700/50" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          ...
          <p className="text-emerald-100 mt-2">나주시청 보도자료 및 시정 소식</p>
        </div>
      </div>
                ...
                >
                  <div className="flex">
                    ...
                    <div className="flex-1 p-4">
                      ...
                      <h2 className="font-bold text-gray-900 line-clamp-2 mb-2 group-hover:text-emerald-600">
                        {article.title}
                      </h2>
                      {article.summary && (
