...
import { Users, Clock, Loader2, ChevronRight, ChevronLeft } from 'lucide-react';
...
export default function NajuCouncilPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative text-white py-12 md:py-16 overflow-hidden">
        {/* Background Image */}
        <Image
          src="/images/hero/council-hero.png"
          alt="의회 소식 배경"
          fill
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          ...
          <p className="text-blue-100 mt-2">나주시의회 의정활동 및 소식</p>
        </div>
      </div>
                ...
                >
                  <div className="flex">
                    ...
                    <div className="flex-1 p-4">
                      ...
                      <h2 className="font-bold text-gray-900 line-clamp-2 mb-2 group-hover:text-blue-600">
                        {article.title}
                      </h2>
                      {article.summary && (
